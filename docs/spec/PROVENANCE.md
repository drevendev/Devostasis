...
| `PV-BAND-ORDER-001`, `devostasis.band-order.v1` | PV-BAND-ORDER-001 | accepted, adoption authorized; adopted in 0.1.8 with cases ORDER-01..15. Ordering is per Vital only; the conformance review of the adoption is PV-SPEC-001 |
